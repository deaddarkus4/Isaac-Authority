...
enum Action : int { Left = 0, Right, Up, Down, ShootLeft, ShootRight, ShootUp, ShootDown, Bomb, Item, PillCard, Drop, kActions };
struct Command {
    ...
    std::uint32_t buttons = 0;                          // bit n is Action(Bomb + n)
};
